...
export const parkside = [
  `I am a product-oriented software developer with over 4 years of professional experience building enterprise-grade dynamic web apps using primarily TypeScript, Vue.js, and Less CSS.
...
export const grazGeneral = [
  `I am a product-oriented software developer with over 4 years of professional experience building enterprise-grade dynamic web apps using TypeScript, Vue.js, and Less CSS,
